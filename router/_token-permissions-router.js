...
let Controller;
if (!fs.existsSync(path.resolve(global.appRoot + "/src/controller/TokenPermissionController.js"))) {
	Controller = require('../controller/RoleController');
} else {
	Controller = require(global.appRoot + "/src/controller/TokenPermissionController");
}
